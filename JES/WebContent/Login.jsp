    ...
    <a href="Myacclogin.jsp">Output History</a>
     ...
     <form name="Login" action="http://localhost:8081/JES/LoginServlet" onsubmit="return loginValidation()" method="post">
		 <center style="font-size:60%;">
		 	<p style="color:blue;">${regsuccess}${pswdchngsucs} </p><br />
	 ...
	 <input type="submit" value="Submit" />   <button onClick="window.location='Forgotpassword.jsp';">Forgot Password</button>   <button onclick="goBack()">Go Back</button></pre></p>
