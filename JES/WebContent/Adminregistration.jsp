    ...
    <head>
        ...
        { 
           ...
           if (Registration.password.value.length<=5){
            ...
            else if (Registration.uniquepassword.value.length<=5){
            	document.getElementById('erruniqpswd').innerHTML=" Min. password length is 6 ";
                return false;
            }
...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  <div id="myDropdown2" class="dropdown-content2">
    ...
    <a href="Myacclogin.jsp">Update DB</a>
    <a href="Myacclogin.jsp">Calculate Penalty</a>
    <a href="Myacclogin.jsp">Output History</a>
      ...
      <a href="Contactus.jsp">Contact Us</a>
		...
		<center style="font-size:60%;">	<p style="color:red;">${regfailure}</p>
	 				<p style="color:red;">${existsmessage}</p>
                    <legend>Admin Registration</legend></br>
                    <legend>
			...
			<div style="color:red;" id="errlname"></div>
                      ...
                      <!--   <label>Date Of Birth</label>
                       <input type="date" name="dateofbirth" required/>
                        ...
                        <input id="contactnumber" type="tel" name="contactnumber" placeholder="Enter Contact Number" pattern="^\d{3}\d{3}\d{4}$" title="This should be 10 digits" required >
			<br />
                        <label>Street:</label>
	...
	<option value="Wyoming">Wyoming</option>
			...
			<br />
                        ...
                        <br/>
                        <label>Type :</label>
                        <input type="text" name="type" value="Admin"  readonly required />
                        <br/>
                        
                        <label>User Id:</label>
						<input type="email" name="email" id="email" placeholder="User Id is your Email Id" required/>
			<br />
	                ...
	                <option value="In what city were you born">3:In what city were you born</option>
                        ...
                        <input type="password" name="answer1" placeholder="Enter security answer" required />
			<br />
