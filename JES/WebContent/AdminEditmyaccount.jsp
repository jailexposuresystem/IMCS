    ...
    <a href="Adminviewhistory.jsp">Output history</a>
      ...
      <a href="AdminContactus.jsp">Contact Us</a>
       ...
       <center style="font-size:75%;">
		...
		<%
		try
		{   String emil = (String) request.getSession().getAttribute("adminemail");
		...
		<form action="http://localhost:8081/JES/AEditmyaccountServlet" name="Editmyaccount" onsubmit="return editValidate()" method="post">
