...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  ...
  <!--       <h2 align="center">Welcome  <%= request.getSession().getAttribute("name") %></h2>  --> 
  		<center>
  		<h5>If you want to search penalty , click here<a href="Calculatepenalty.jsp"><button>Calculate Penalty</button></a></br>
        If you want to view your search history , click here <a href="Viewhistory.jsp"><button>View History</button></a></h5>
        <br/><br/><br/><br/><br/><br/>
