...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  ...
  <br /><br />
	 ...
	 <input type="submit" value="Submit" style:style="align=center;" />   <button onClick="window.location='Forgotpassword.jsp';">Forgot Password</button>  <button onclick="goBack()">Go Back</button></pre></p>
