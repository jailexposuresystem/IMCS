...
<br/>
<br/>
 <p><img src="logo.jpg" alt="Smiley face" height="250" width="320" align="left"/>
<pre><h2 style="font-size:100%;">        

      Jail Exposure System will allow the user to enter the crimes they are accused of and 
      the software provides the maximum and minimum jail exposure and also fine exposure.
      Using Jail Exposure System website, any offender who are legally charged can gather 
      information regarding the charges filed against him by using Jail Exposure System.
      This system tells what the charges are and the maximum, minimum exposure to jail time.</h2></pre>
</p>
 
        <center><button onclick="goBack()">Go Back</button><a href="Logout.jsp"><button>Exit</button></a></center>
