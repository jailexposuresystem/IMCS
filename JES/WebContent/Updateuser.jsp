...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  ...
  <%	  
	...
	try{
		...
		<form  action="http://localhost:8081/JES/UpdateUserServlet" name="Editmyaccount" onsubmit="return editValidate()" method="post">
		
			<legend>Change:</legend><br/>
			
			<label>User Id:</label>
			<input type="text" name="email"  value="<%=rs.getString("email")%>" readonly required />
			<br />
	...
	<option value="Wyoming">Wyoming</option>
			...
			<input type="text" name="password"  value="<%=rs.getString("password")%>" readonly required />
			<br />
			<label>Security Question:</label>
			<input type="text" name="security1"  value="<%=rs.getString("security1")%>" readonly required />
			<br />
			<label>Security Answer:</label>
			<input type="text" name="answer1"  value="<%=rs.getString("answer1")%>" readonly required />
			<br />
