...
<button onclick="myFunction2()" class="dropbtn2">Reports&#9207</button>
  <div id="myDropdown2" class="dropdown-content2">
    ...
    <a href="UserUpdatedb.jsp">DB Update</a>
    <a href="Calculatepenalty.jsp">Calculate Penalty</a>
    <a href="Viewhistory.jsp">Output History</a>
      ...
      <a href="UserContactus.jsp">Contact Us</a>
		...
		<br/>
			<legend>Calculate Penalty</legend>           
						...
						<label>Class A</label>
			<input type="text" name="MClassA" id="MA" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
                        <label>Class B</label>
			<input type="text" name="MClassB" id="MB" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
                        <label>Class C</label>
			<input type="text" name="MClassC" id="MC" pattern="[0-9]" title="Only Numbers" value="0" maxlength="2" size="3" required/>
			<br />
                        <label>Class D</label>
			<input type="text" name="MClassD" id="MD" pattern="[0-9]" title="Only Numbers" value="0" maxlength="2" size="3" required/>
			<br />
			
						<p>Class Type : Felony</p>
			     
						<label>Class A</label>
			<input type="text" name="FClassA" id="A" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
                        <label>Class B</label>
			<input type="text" name="FClassB" id="B" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
                        <label>Class C</label>
			<input type="text" name="FClassC" id="C" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
                        <label>Class D</label>
			<input type="text" name="FClassD" id="D" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
			            <label>Class E</label>
			<input type="text" name="FClassE" id="E" value="0" pattern="[0-9]" title="Only Numbers" maxlength="2" size="3" required/>
			<br />
			<div style="color:red;" id="errclasses"></div>
			<br>
			

			<input type="submit" value="submit" /></center></form>&nbsp;&nbsp;&nbsp;<center>
		If you want to view the list of crimes under all classes <input type="button" value="Click Here" onclick="window.open('https://www.cga.ct.gov/2012/rpt/2012-R-0134.htm')" />
			&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="goBack()">Go Back</button>
			<a href="Logout.jsp"><button>Exit</button></a></center>
